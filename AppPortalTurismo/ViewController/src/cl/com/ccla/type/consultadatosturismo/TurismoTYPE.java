 ...
 *       &lt;sequence>
 *         &lt;element name="NroReserva" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
...
@XmlType(name = "TurismoTYPE",
         propOrder = { "nroReserva", "codigoReserva", "checkIn", "checkOut",
                       "centro", "mntPendiente", "estado", "tipoHabitacion",
                       "nroHabitacion", "capacidadHabitacion", "fechaGrab",
                       "numeroComprobante", "estadoCi", "montoCi",
                       "cuentaPeriodo", "region", "codigoSucursal",
                       "tipoDocumento", "correlativoComprobante", "cuota",
                       "idCuota" })
public class TurismoTYPE {

    @XmlElementRef(name = "NroReserva",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<BigDecimal> nroReserva;
    @XmlElementRef(name = "CodigoReserva",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<String> codigoReserva;
    @XmlElementRef(name = "CheckIn",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> checkIn;
    @XmlElementRef(name = "CheckOut",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> checkOut;
    @XmlElementRef(name = "Centro",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<String> centro;
    @XmlElementRef(name = "MntPendiente",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<BigDecimal> mntPendiente;
    @XmlElementRef(name = "Estado",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<String> estado;
    @XmlElementRef(name = "TipoHabitacion",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<String> tipoHabitacion;
    @XmlElementRef(name = "NroHabitacion",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<BigDecimal> nroHabitacion;
    @XmlElementRef(name = "CapacidadHabitacion",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<BigDecimal> capacidadHabitacion;
    @XmlElementRef(name = "FechaGrab",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                   type = JAXBElement.class)
     ...
     *
     */
    public JAXBElement<BigDecimal> getNroReserva() {
        return nroReserva;
    }

    /**
     * Sets the value of the nroReserva property.
     *
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *
     */
    public void setNroReserva(JAXBElement<BigDecimal> value) {
     ...
     *
     */
    public JAXBElement<String> getCuota() {
        return cuota;
    }
     ...
     *
     */
    public void setCuota(JAXBElement<String> value) {
        this.cuota = value;
    }
