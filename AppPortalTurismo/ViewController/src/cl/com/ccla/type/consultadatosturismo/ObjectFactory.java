...
public class ObjectFactory {
    ...
    private final static QName _TurismoTYPENroHabitacion_QNAME =
        new QName("http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                  "NroHabitacion");
    private final static QName _TurismoTYPECuota_QNAME =
        new QName("http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                  "Cuota");
    ...
    private final static QName _TurismoTYPEEstado_QNAME =
        new QName("http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                  "Estado");
    private final static QName _TurismoTYPENroReserva_QNAME =
        new QName("http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                  "NroReserva");
    ...
    @XmlElementDecl(namespace =
                    "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                    name = "Cuota", scope = TurismoTYPE.class)
    public JAXBElement<String> createTurismoTYPECuota(String value) {
        return new JAXBElement<String>(_TurismoTYPECuota_QNAME, String.class,
                                       TurismoTYPE.class, value);
    }
    ...
    @XmlElementDecl(namespace =
                    "http://ccla.cl/enterprise/catalogo/ebm/datosTurismo",
                    name = "NroReserva", scope = TurismoTYPE.class)
    public JAXBElement<BigDecimal> createTurismoTYPENroReserva(BigDecimal value) {
        return new JAXBElement<BigDecimal>(_TurismoTYPENroReserva_QNAME,
                                           BigDecimal.class, TurismoTYPE.class,
                                           value);
    }
