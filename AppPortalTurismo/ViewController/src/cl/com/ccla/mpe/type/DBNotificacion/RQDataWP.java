...
@XmlType(name = "RQ_Data_WP",
         propOrder = { "token", "accountingDate", "buyOrder", "cardNumber",
                       "cardExpirationDate", "sessionId", "transactionDate",
                       "urlRedirection", "vci", "authorizationCode",
                       "paymentTypeCode", "responseCode", "amount",
                       "sharesNumber", "commerceCode" })
