 ...
 * generated in the cl.com.ccla.mpe.type.DBNotificacion package.
...
public class ObjectFactory {
    ...
    private final static QName _NotificarTrxWPRS_QNAME =
        new QName("http://producto.notificacion.dashboard.ws.ccla.cl/",
                  "NotificarTrx_WPRS");
    private final static QName _NotificarTrxWPRQ_QNAME =
        new QName("http://producto.notificacion.dashboard.ws.ccla.cl/",
                  "NotificarTrx_WPRQ");
    private final static QName _NotifProdRQ_QNAME =
        new QName("http://producto.notificacion.dashboard.ws.ccla.cl/",
                  "Notif_ProdRQ");
    private final static QName _NotificarTrxProdRS_QNAME =
        new QName("http://producto.notificacion.dashboard.ws.ccla.cl/",
                  "NotificarTrx_ProdRS");
    private final static QName _DataWPRQ_QNAME =
        new QName("http://producto.notificacion.dashboard.ws.ccla.cl/",
                  "Data_WPRQ");
    private final static QName _NotificarTrxProdRQ_QNAME =
        new QName("http://producto.notificacion.dashboard.ws.ccla.cl/",
                  "NotificarTrx_ProdRQ");
    private final static QName _Status_QNAME =
        new QName("http://producto.notificacion.dashboard.ws.ccla.cl/",
                  "Status");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cl.com.ccla.mpe.type.DBNotificacion
     *
     */
    ...
    @XmlElementDecl(namespace =
                    ...
                    name = "NotificarTrx_WPRS")
    public JAXBElement<RSNotificarTrxWP> createNotificarTrxWPRS(RSNotificarTrxWP value) {
        return new JAXBElement<RSNotificarTrxWP>(_NotificarTrxWPRS_QNAME,
                                                 RSNotificarTrxWP.class, null,
                                                 value);
    }
    ...
    public JAXBElement<RQNotificarTrxWP> createNotificarTrxWPRQ(RQNotificarTrxWP value) {
        return new JAXBElement<RQNotificarTrxWP>(_NotificarTrxWPRQ_QNAME,
                                                 RQNotificarTrxWP.class, null,
                                                 value);
    }
    ...
    public JAXBElement<RQNotifProd> createNotifProdRQ(RQNotifProd value) {
        return new JAXBElement<RQNotifProd>(_NotifProdRQ_QNAME,
                                            RQNotifProd.class, null, value);
    }
    ...
    @XmlElementDecl(namespace =
                    "http://producto.notificacion.dashboard.ws.ccla.cl/",
                    name = "NotificarTrx_ProdRS")
    public JAXBElement<RSNotificarTrxProd> createNotificarTrxProdRS(RSNotificarTrxProd value) {
        return new JAXBElement<RSNotificarTrxProd>(_NotificarTrxProdRS_QNAME,
                                                   RSNotificarTrxProd.class,
                                                   null, value);
    }
    ...
    public JAXBElement<RQDataWP> createDataWPRQ(RQDataWP value) {
        return new JAXBElement<RQDataWP>(_DataWPRQ_QNAME, RQDataWP.class, null,
                                         value);
    }
    ...
    @XmlElementDecl(namespace =
                    "http://producto.notificacion.dashboard.ws.ccla.cl/",
                    name = "NotificarTrx_ProdRQ")
    public JAXBElement<RQNotificarTrxProd> createNotificarTrxProdRQ(RQNotificarTrxProd value) {
        return new JAXBElement<RQNotificarTrxProd>(_NotificarTrxProdRQ_QNAME,
                                                   RQNotificarTrxProd.class,
                                                   null, value);
    }
    ...
    public JAXBElement<RSStatus> createStatus(RSStatus value) {
        return new JAXBElement<RSStatus>(_Status_QNAME, RSStatus.class, null,
                                         value);
    }
