...
@XmlType(name = "HistorialTurismoTYPE",
         propOrder = { "rutPersona", "numeroComprobante", "fechaComprobante",
                       "codigoReserva", "checkOut", "checkIn", "numeroCuota",
                       "centroTuristico", "monto", "fechaPago",
                       "fechaVencimiento", "idTransaccion",
                       "idTransaccionCaja", "estadoPago", "numeroBoleta" })
public class HistorialTurismoTYPE {

    @XmlElementRef(name = "rutPersona",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/historialTurismo",
    ...
    @XmlElementRef(name = "fechaComprobante",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/historialTurismo",
                   type = JAXBElement.class)
    ...
    @XmlElementRef(name = "centroTuristico",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/historialTurismo",
                   type = JAXBElement.class)
    ...
    @XmlElementRef(name = "idTransaccion",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/historialTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<String> idTransaccion;
    @XmlElementRef(name = "idTransaccionCaja",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/historialTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<String> idTransaccionCaja;
    @XmlElementRef(name = "estadoPago",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/historialTurismo",
                   type = JAXBElement.class)
    protected JAXBElement<String> estadoPago;
    @XmlElementRef(name = "numeroBoleta",
                   namespace = "http://ccla.cl/enterprise/catalogo/ebm/historialTurismo",
                   type = JAXBElement.class)
