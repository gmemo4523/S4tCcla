...
import cl.com.ccla.type.consultadatosturismo.ListaTurismo;

import cl.com.ccla.type.consultadatosturismo.Persona;

import cl.com.ccla.type.consultadatosturismo.PersonaTYPE;
import cl.com.ccla.type.consultadatosturismo.Turismo;
...
public class ConsultarDatosTurismoBean {
    ...
    public ListaTurismo HistorialTurismo(String input) {
        ...
        cl.com.ccla.type.consultadatosturismo.ObjectFactory factory = new cl.com.ccla.type.consultadatosturismo.ObjectFactory();
        ...
        for (int i = 0; i < response.getListaTurismo().getTurismo().size(); i++) {
            ...
            tur.setEstadoN(response.getListaTurismo().getTurismo().get(i).getEstadoN().getValue());
